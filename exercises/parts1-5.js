...
// console.log(`Days to Mars for ${spacecraftName}: ${daysToMars}\n`);
// // Part 3: Create a Function ("getDaysToLocation")
// // Takes 2 arguments: distance away from location in KM but speed in MPH :(
// function getDaysToLocation(kilometersAway: number, speedMph = 17500): number {
//     let milesToLocation: number = kilometersAway * 0.621; // convert km to miles
...
var Spacecraft = /** @class */ (function () {
    ...
    Spacecraft.prototype.getDaysToLocation = function (kilometersAway) {
        var milesToLocation = kilometersAway * this.milesPerKilometer; // convert km to miles
